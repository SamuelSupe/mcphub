...
Repository: [SamuelSupe/mcphub](https://github.com/SamuelSupe/mcphub) · documented release: v1.1.0 · module: `github.com/SamuelSupe/mcphub` · [release notes](RELEASE_NOTES_v1.1.0.md) · license: [Apache License 2.0](LICENSE)
...
仓库：[SamuelSupe/mcphub](https://github.com/SamuelSupe/mcphub) · 当前文档版本：v1.1.0 · module：`github.com/SamuelSupe/mcphub` · [发行说明](RELEASE_NOTES_v1.1.0.md) · 许可证：[Apache License 2.0](LICENSE)
